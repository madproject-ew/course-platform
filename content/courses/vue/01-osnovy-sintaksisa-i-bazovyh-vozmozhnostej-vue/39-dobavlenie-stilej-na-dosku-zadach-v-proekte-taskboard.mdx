---
title: "Добавление стилей на доску задач в проекте TaskBoard"
type: demo
---

# Шаг 1. Добавление стилей к компоненту HomeView

Осталось добавить стили в файл `HomeView.vue`, чтобы доска задач отображалась корректно.
...
# Шаг 2. Импорт стилей в корневой компонент

В файл `App.vue` добавим импорт глобальных стилей:
